...
const BackgroundCircles = () => {
  return (
    ...
    className="relative flex justify-center items-center">
        ...
        <div className="rounded-full border border-black opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
        <div className="rounded-full border border-black h-[800px] w-[800px] absolute mt-52" />
